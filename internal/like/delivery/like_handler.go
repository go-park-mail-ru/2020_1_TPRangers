...
func (Like LikeDelivery) LikeComment(rwContext echo.Context) error {
	...
	err = Like.likeLogic.LikeComment(commentId, userId)
...
func (Like LikeDelivery) DislikeComment(rwContext echo.Context) error {
	...
	err = Like.likeLogic.DislikeComment(commentId, userId)
...
func (Like LikeDelivery) InitHandlers(server *echo.Echo) {
	...
	server.POST("/api/v1/comment/:id/like", Like.LikeComment)
	server.DELETE("/api/v1/comment/:id/like", Like.DislikeComment)
}
