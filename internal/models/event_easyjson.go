...
func easyjsonF642ad3eDecodeMainInternalModels(in *jlexer.Lexer, out *JSONEvent) {
	...
	for !in.IsDelim('}') {
		...
		case "message":
			easyjsonF642ad3eDecodeMainInternalModels1(in, &out.Message)
		default:
			in.SkipRecursive()
		}
		in.WantComma()
...
func easyjsonF642ad3eEncodeMainInternalModels(out *jwriter.Writer, in JSONEvent) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	}
	{
		...
		easyjsonF642ad3eEncodeMainInternalModels1(out, in.Message)
	}
	out.RawByte('}')
}

// MarshalJSON supports json.Marshaler interface
func (v JSONEvent) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonF642ad3eEncodeMainInternalModels(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}

// MarshalEasyJSON supports easyjson.Marshaler interface
func (v JSONEvent) MarshalEasyJSON(w *jwriter.Writer) {
	easyjsonF642ad3eEncodeMainInternalModels(w, v)
}

// UnmarshalJSON supports json.Unmarshaler interface
func (v *JSONEvent) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonF642ad3eDecodeMainInternalModels(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *JSONEvent) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonF642ad3eDecodeMainInternalModels(l, v)
}
func easyjsonF642ad3eDecodeMainInternalModels1(in *jlexer.Lexer, out *Message) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonF642ad3eEncodeMainInternalModels1(out *jwriter.Writer, in Message) {
	out.RawByte('{')
	first := true
	_ = first
	{
